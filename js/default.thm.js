...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function FrameSkin() {
		_super.call(this);
		this.skinParts = ["mapGrp","imgLeft1","imgRight1","imgLeft2","imgRight2","Grp"];
		
		this.height = 930;
		this.width = 580;
		this.elementsContent = [this._Rect1_i(),this.mapGrp_i(),this.Grp_i()];
	}
	var _proto = FrameSkin.prototype;
	...
	_proto.Grp_i = function () {
		...
		t.right = 0;
		t.y = -1804;
		t.elementsContent = [this.imgLeft1_i(),this.imgRight1_i(),this.imgLeft2_i(),this.imgRight2_i()];
		return t;
	};
	_proto.imgLeft1_i = function () {
		var t = new eui.Image();
		this.imgLeft1 = t;
		t.left = 0;
		t.source = "leaf_left_png";
		t.y = 0;
		return t;
	};
	_proto.imgRight1_i = function () {
		var t = new eui.Image();
		this.imgRight1 = t;
		t.right = 0;
		t.source = "leaf_right_png";
		t.y = 0;
		return t;
	};
	_proto.imgLeft2_i = function () {
		var t = new eui.Image();
		this.imgLeft2 = t;
		t.left = 0;
		t.source = "leaf_left_png";
	...
	return FrameSkin;
})(eui.Skin);generateEUI.paths['resource/exml/jump/PlayerSkin.exml'] = window.PlayerSkin = (function (_super) {
	__extends(PlayerSkin, _super);
	function PlayerSkin() {
		_super.call(this);
		this.skinParts = ["mcGrp"];
		
		this.height = 105;
		this.width = 105;
		this.elementsContent = [this.mcGrp_i()];
	}
	var _proto = PlayerSkin.prototype;

	_proto.mcGrp_i = function () {
		var t = new eui.Group();
		this.mcGrp = t;
		t.left = 0;
		t.top = 0;
	...
	return PlayerSkin;
})(eui.Skin);generateEUI.paths['resource/exml/jump/StoneSkin.exml'] = window.StoneSkin = (function (_super) {
	__extends(StoneSkin, _super);
	function StoneSkin() {
		_super.call(this);
		this.skinParts = ["icon"];
	...
	var _proto = StoneSkin.prototype;
	...
	_proto.btnStart_i = function () {
		...
		t.horizontalCenter = 0;
		t.label = "开始游戏";
		t.skinName = "Button_01";
		t.width = 164;
		return t;
	};
	return MainSkin;
})(eui.Skin);generateEUI.paths['resource/exml/main/WelcomeSkin.exml'] = window.WelcomeSkin = (function (_super) {
	__extends(WelcomeSkin, _super);
	function WelcomeSkin() {
		_super.call(this);
		this.skinParts = ["imgTest","labTip"];
		
		this.height = 930;
		this.width = 580;
		this.elementsContent = [this.imgTest_i(),this.labTip_i()];
	}
